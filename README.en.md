...
| [`docs/measurements.md`](docs/measurements.md) | **Primary source for measurements**, M-1–M-87. Every entry has a reproduction command |
| [`docs/decisions.md`](docs/decisions.md) | Decisions D-001–D-047 and the **correction log C-001–C-055** |
