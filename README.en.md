...
| [`docs/decisions.md`](docs/decisions.md) | Decisions D-001–D-042 and the **correction log C-001–C-047** |
...
- **Never delete the correction log.** **47 entries** record errors of the form
