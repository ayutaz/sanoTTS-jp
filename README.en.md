...
| [`docs/decisions.md`](docs/decisions.md) | Decisions D-001–D-041 and the **correction log C-001–C-042** |
...
- **Never delete the correction log.** **42 entries** record errors of the form
