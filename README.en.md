...
> ([M-77](docs/measurements.md)). The audio came out **bit-identical** to the frozen
...
| [`docs/measurements.md`](docs/measurements.md) | **Primary source for measurements**, M-1–M-77. Every entry has a reproduction command |
