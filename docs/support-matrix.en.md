...
| **Memory** (fits 512 KB SRAM) | ✅ **118,784 B** (kana) / **139,264 B** (kanji) static arena ([M-144](measurements.md#m-144)). ⚠️ The **110,592 B** measured peak and **160,639 B** free at boot (largest block 114,688) were taken with a 151,552 B arena and have **not** been re-measured on hardware | [M-142](measurements.md#m-142) / [M-144](measurements.md#m-144) |
