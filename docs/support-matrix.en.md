...
| **Real-time budget** (xRT ≤ 0.5) | ✅ **0.471–0.475** steady-state over 7 utterances — the denominator was **settled** in [D-049](decisions.md#d-049). ⚠️ 0.522–0.741 over a whole utterance, kept only **for reference** (otherwise the verdict would depend on sentence length alone). Time to first sound **364–374 ms ≤ 0.8 s** (53–55% margin). ⚠️ Up to **v1.1.0** it was 0.444–0.448 — it is slower by exactly the 28,840 B of RAM that was reclaimed ([M-142](measurements.md#m-142)). ⚠️ **Not re-measured on hardware after MEM-7 / MEM-8** ([M-144](measurements.md#m-144) / [M-145](measurements.md#m-145)); the PCM is bit-identical on the host | [M-142](measurements.md#m-142) / [C-054](decisions.md#c-054) |
| **Memory** (fits 512 KB SRAM) | ✅ **183,979 B static DIRAM** (measured from the kana build — 53.8% of the DIRAM pool, 157,781 B free), of which the arena is **118,784 B** (kana) / **139,264 B** (kanji) ([M-145](measurements.md#m-145)). ⚠️ The **110,592 B** measured peak and **160,639 B** free at boot (largest block 114,688) were taken with a 151,552 B arena and have **not** been re-measured on hardware | [M-142](measurements.md#m-142) / [M-145](measurements.md#m-145) |
