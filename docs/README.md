...
| 1 | [`decisions.md`](decisions.md) | 意思決定の記録 D-001〜D-059（⚠️ **D-049 は欠番** = RTF の分母用に予約）と**訂正履歴 C-001〜C-082** | 決定のたび |
...
## 残っているタスク（**2026-09-10 更新。残り 4 件: 聴取 1 / 判断 1 / リリース 1 / 帰属の差し替え 1**）
...
│   ├── decisions.md                       決定記録 D-001〜D-059（D-049 は欠番）+ 訂正履歴 C-001〜C-082
