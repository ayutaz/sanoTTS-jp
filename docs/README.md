...
[完了] E-1 DNSMOS           生徒/教師 **0.7725**（M-50 / v2）。上流の主張は**再現せず**
                            ⚠️ v3 では **0.8385**（M-59）
...
[完了] 成果物を v3 に差し替え  **Stage 3 を 40k → 80k にしただけで 5 指標すべて改善**（M-59 / D-037）
                            SCOREQ 比 0.6113→**0.6613** / かな CER +0.0425→**+0.0034（教師と区別不能）**
                            DNSMOS 比 0.7725→**0.8385** / アクセント 35/36→**37/37** / int8 最小 SNR 23.27→**25.72 dB**
...
**品質は目標に届いた**（SCOREQ 教師比 **0.6613** > 論文の英語比 0.5427。M-59 / v3）。
