...
| 2 | [`measurements.md`](measurements.md) | **実測値の一次ソース** M-1〜M-147。全数値に再現コマンド付き | 実測のたび |
...
│   ├── measurements.md                    実測値の一次ソース M-1〜M-147
