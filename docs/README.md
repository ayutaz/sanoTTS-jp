...
| 2 | [`measurements.md`](measurements.md) | **実測値の一次ソース** M-1〜M-75。全数値に再現コマンド付き | 実測のたび |
...
│   ├── decisions.md                       決定記録 D-001〜D-043 + 訂正履歴 C-001〜C-051
│   ├── measurements.md                    実測値の一次ソース M-1〜M-75
