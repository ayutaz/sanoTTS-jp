...
| 1 | [`decisions.md`](decisions.md) | 意思決定の記録 D-001〜D-065（✅ **D-049 の欠番は 2026-09-11 に埋めた** = RTF の分母）と**訂正履歴 C-001〜C-097** | 決定のたび |
| 2 | [`measurements.md`](measurements.md) | **実測値の一次ソース** M-1〜M-138。全数値に再現コマンド付き | 実測のたび |
...
├── docs/
│   ├── README.md                          このファイル
│   ├── decisions.md                       決定記録 D-001〜D-065（**D-049 も埋まった**）+ 訂正履歴 C-001〜C-097
│   ├── measurements.md                    実測値の一次ソース M-1〜M-138
