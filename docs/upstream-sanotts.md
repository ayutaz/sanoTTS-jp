...
| RAM（ストリーミング） | 130〜160 KB | **196.9 KB**（350 ids の arena 192.8 KB + FFT stack 4.1 KB。S1 前）→ 現在は **350 ids の `arena_peak` が 115,440 B**（ターゲット / W8A8）。実機向けの静的確保は **かな 118,784 B / 漢字 139,264 B**、静的 DIRAM 全体で **183,979 B**（⚠️ タスクスタックは別勘定）。⚠️ **180,224 / 157,360 B と書いてあったのは v1.1.0 の値** | M-42 / M-89 / [M-145](measurements.md#m-145) |
