...
|---|---:|---:|---:|---|
| 既定（W8A32） | 284,832 B | 29,006 B | 0 | UART0 |
| **W8A8 + PIE** | **286,176 B** | **29,308 B** | **5** | UART0 |
| W8A8 + PIE | 271,776 B | 29,308 B | 5 | USB Serial/JTAG |

⚠️ **UART ドライバが 14.4 KB 効いている**（286,176 − 271,776）。
