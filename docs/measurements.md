...
| # | 条件 | 結果 |
|---|---|---|
| **G1** | ピーク RAM < 200 KB | ✅ **197.0 KB**（実用最大 350 ids / 785 frames） |
...
| 発話 | FFT 化前 | **FFT 化後** | 改善 |
|---|---:|---:|---:|
| short (106 frames) | 0.228 | **0.037** | 6.2x |
| medium (323 frames) | 0.219 | **0.027** | 8.1x |
| long (785 frames) | 0.215 | **0.024** | 8.9x |
