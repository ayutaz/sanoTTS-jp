...
<details>
<summary><b>索引（141 件）</b> — ⚠️ <b>新しいものほど下</b>。食い違ったら<b>下</b>が正</summary>
...
| [M-140](#m-140) | 既定の RAM を 41,168 B 減らした |
...
<a id="m-140"></a>
## M-140. **既定の RAM を 41,168 B 減らした** — arena 176 → 136 KB。**PCM は bit 一致**、定常 xRT 0.448 → 0.483（要件内）（自己実測 / M5 CoreS3）
