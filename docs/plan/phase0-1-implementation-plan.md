...
| **5** | **速度の作り直し S1〜S8**（[`../research/s1-m5-cores3-speed.md`](../research/s1-m5-cores3-speed.md) §5）。第三者の実機報告 **1.554× RT** を受けて起票（2026-09-02） | かな | all-test / QEMU checksum / 実機プロファイル | S1〜S6 は ❌ 不要（ホスト + QEMU で bit 一致まで確かめられる）。効果の確認は ✅ 要る |
