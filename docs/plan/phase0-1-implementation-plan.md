...
✅ E-1      DNSMOS                     生徒/教師 0.7725（v2）→ **v3 は 0.8385**。上流の主張は再現せず（M-50 / D-034）
...
| 軸 | 状態 |
|---|---|
| 品質 | ✅ SCOREQ 教師比 **0.6613** / DNSMOS 教師比 **0.8385** / **かな CER は教師と区別できない**（差 +0.0034）/ アクセント **37/37**（すべて v3。M-59）。⚠️ n=24 / **聴取は未実施** |
