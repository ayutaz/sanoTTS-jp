...
| **11** | **4 MB / 2 MB を実機で測るか**（M-106 §12。QEMU では通ったが**速度も音も未測定**） | 人が要る | 16 MB の CoreS3 に 4 MB / 2 MB の表を焼けば測れる（M-105 の 8 MB と同じ手）。⚠️ **4 MB flash のチップそのものは持っていない** |
...
| **4 MB** | **3,006,656** | **135,000** | **1.94%** | ✅ QEMU（M-106 §11） |
| **2 MB 枠** | **977,456** | **44,000** | **3.86%** | ✅ QEMU（M-106 §13） |
