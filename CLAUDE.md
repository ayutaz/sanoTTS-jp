...
**どれも実機で動き、速度の要件も満たし、`v1.1.0` として配っている**（重み・firmware・辞書は `v1.0.0` と bit 同一）。
...
## 残っているタスク（2026-09-13 更新。**残り 3 件。どれも人が要る** — ⚠️ **判断も作業も全部片づいた**）
...
✅ **いま配っているのは `v1.1.0`**（2026-09-13。資産 30 本 = Arduino の .zip 2 本を足しただけ。[M-138](docs/measurements.md#m-138)）。
