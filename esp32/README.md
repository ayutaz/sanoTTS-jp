...
| arena（静的確保） | 212,992 B | **かな 118,784 / 漢字 139,264 B**。静的 DIRAM は **漢字 211,535 B（実機実測。v1.1.0 の 232,015 から −20,480）/ かな 186,683 B**。1 発話のピークは **113,072〜115,056 B** で `arena_peak(n)` と 6 点一致 = [M-147](../docs/measurements.md#m-147) |
...
⚠️ **下のログは arena 148 KB のとき（M-142）の実機出力**で、M-144 の arena では
**まだ実機で測っていない**（数字を書き換えると「どの実機も出していない出力」になる = [C-090](../docs/decisions.md#c-090)）:
