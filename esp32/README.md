...
| 7 | **内部 DRAM の残り** | `起動直後: 内部 DRAM free ... / 最大ブロック ...` | arena を引いた後どれだけ残るか。⚠️ **M5 の漢字ビルドの 160,639 B / 最大ブロック 114,688 は arena 148 KB のときの実測**（M-142。v1.1.0 は 131,799 / 86,016）。**M-144 で arena を 12,288 B 減らしたぶん増える見込みだが実機未測定** |
