...
| arena（静的確保） | 212,992 B | **かな 118,784 / 漢字 139,264 B**。静的 DIRAM は **183,979 B**（かな構成。M-142 比 **−43,664 B** = [M-145](../docs/measurements.md#m-145)）。⚠️ **実機の used 110,592 B は arena 151,552 B のときの値** = M-142 |
