...
> ✅ **2026-09-03、M5 のスピーカー構成にも載って喋った**（M-90。W8A8+PIE で xRT 0.446、`!` 不要）。⚠️ **音は未聴取。**
...
| **音の良し悪しを人の耳で言う** | ⚠️ **聴取が 1 名 1 回しかない**（β の決定。M-60）。実機で喋った音は**誰も聴いていない**。漢字経路も 0 名。**これが今いちばん足りないもの** |
...
| [`docs/measurements.md`](docs/measurements.md) | **実測値の一次ソース** M-1〜M-90。全項目に再現コマンド付き |
| [`docs/decisions.md`](docs/decisions.md) | 決定 D-001〜D-048 と**訂正履歴 C-001〜C-055** |
