...
| **E** | **ブラウザで試す**（⚠️ **準備中**） | ブラウザだけ。**インストール不要** | 1 分 |
...
### E. ブラウザで試す（⚠️ **準備中 — まだ開けません**）

**`https://ayutaz.github.io/sanoTTS-jp/`** に、この C99 コアをそのまま WebAssembly にした
デモを置く予定。⚠️ **2026-09-03 現在、GitHub Pages がまだ有効になっていないので
このリンクは開きません**（有効化は設定画面での手作業）。

動くようになったら、**インストールも設定も要らず**、入力欄に
